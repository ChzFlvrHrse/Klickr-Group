        ...
        <div className="about-devs-container">
            <div className="about-devs-wrapper">
                <div className="about-us-title-container">
                    ...
                    <a href="https://github.com/ChzFlvrHrse/Klickr-Group">
                ...
                <div className="team-container">
                    <div className="member-container">
                        ...
                        <div className="dev-info-contatiner">
                            <a className="links-container" href="https://github.com/ChzFlvrHrse">
                                <img className="github-icon" src={githubIcon}></img>
                                <div className="linked-titles">Github</div>
                            </a>
                            <a className="links-container" href='https://www.linkedin.com/in/nathan-scott-0a7264183/'>
                    ...
                    <div className="member-container">
                        ...
                        <div className="dev-info-contatiner">
                            <a className="links-container" href="https://github.com/Justinguu">
                                <img className="github-icon" src={githubIcon}></img>
                                <div className="linked-titles">Github</div>
                            </a>
                            <a className="links-container" href='https://www.linkedin.com/in/jung-gu-b69b98154/'>
                                <img className="linkedin-icon" src={linkedIcon}></img>
                                <div className="linked-titles">LinkedIn</div>
                            </a>
                        </div>
                    ...
                    <div className="member-container">
                        ...
                        <div className="dev-info-contatiner">
                            <a className="links-container" href="https://github.com/Kbafekr">
                                <img className="github-icon" src={githubIcon}></img>
                                <div className="linked-titles">Github</div>
                            </a>
                            <a className="links-container" href='https://www.linkedin.com/in/keanen-bafekr-8a498a123/'>
                                <img className="linkedin-icon" src={linkedIcon}></img>
                                <div className="linked-titles">LinkedIn</div>
                            </a>
                        </div>
                    ...
                    <div className="member-container">
                        ...
                        <div className="dev-info-contatiner">
                            <a className="links-container" href="https://github.com/Kevin-D47">
                                <img className="github-icon" src={githubIcon}></img>
                                <div className="linked-titles">Github</div>
                            </a>
                            <a className="links-container" href='https://www.linkedin.com/in/kevin-duong-513341216/'>
                                <img className="linkedin-icon" src={linkedIcon}></img>
                                <div className="linked-titles">LinkedIn</div>
                            </a>
                        </div>
