...
function User() {
  ...
  const userAlbumArr = allAlbumsArr.filter((image) => image.userId == userId);
      ...
      <div className="user-title-container">
        <div className="profile-pic-name">
          ...
          <div className="user-fName-lName-username">
            <div
              style={{ fontSize: "36px", color: "white", fontWeight: "330" }}
            >
              {user.first_name} {user.last_name}
            </div>
            <div className="username-joined">
              <div
                style={{ fontSize: "20px", color: "white", fontWeight: "330" }}
              >
                {user.username}
              </div>
              <div
                className="joined"
                style={{ fontSize: "18px", color: "white", fontWeight: "330" }}
              >
        ...
        <div className="user-showcase-wrapper">
              ...
              {userImagesArr.map((image) => (
                <div className="user-singleImgContainer">
                  ...
                  <div className="explore-image-bttm-section">
                    <div className="hide" style={{ color: "white" }}>
                      {image.title}
                    </div>
                  </div>
                </div>
          ...
          <div className="user-photo-details-container">
            <div className="user-photo-details">
              ...
              <div className="user-photo-details-info">
                <div style={{ fontSize: "22px" }}>{userAlbumArr.length}</div>
                <div style={{ color: "grey" }}>Albums</div>
              </div>
              <div className="user-photo-details-info">
          ...
          <div className="user-info-container">
            <div className="user-info">
              Joined<div className="user-joined">{createdAtDate}</div>
            </div>
            <div className="user-info">
              Email<div className="user-email">{user.email}</div>
            </div>
          </div>
        </div>
      </div>
