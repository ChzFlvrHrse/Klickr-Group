...
def seed_images():
    ...
    image_11 = Image(userId=2, title="Futuristic Home", description="Go Big or Go Home", previewImageUrl="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80")
