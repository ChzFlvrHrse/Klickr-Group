...
def seed_images():
    image_1 = Image(userId=1, albumId=1, title="App Mountain", description="Best view in the mountain ranges", previewImageUrl="https://images.unsplash.com/photo-1663875967691-15b02702931c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80")
    ...
    image_7 = Image(userId=3, albumId=3, title="Inception", description="Nothing is as it's percieved", previewImageUrl="https://images.unsplash.com/photo-1548133650-7e2b96ebe5e6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=681&q=80")
